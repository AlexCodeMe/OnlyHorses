...
export default function Post({ post, isSubscribed, admin }: Props) {
    const user = {
        id: 123,
        ...
        <div className='flex flex-col gap-3 p-3 border-t'>
            ...
            {(post.isPublic || isSubscribed) && post.mediaUrl && post.mediaType === "image" && (
                <div className='relative w-full pb-[56.25%] rounded-lg overflow-hidden'>
                    <Image src={post.mediaUrl} alt='Post Image'
            ...
            <div className='flex gap-4'>
                <div className='flex gap-1 items-center'>
                    <Heart className={cn("w-5 h-5 cursor-pointer", 
                        { "text-red-500": isLiked, "fill-red-500": isLiked })
                    }
